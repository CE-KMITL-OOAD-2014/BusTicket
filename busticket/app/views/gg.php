...
<?php
  if(isset($_POST['txtUsername'],$_POST['txtPassword'],$_POST['phonenum'],$_POST['txtConPassword'],$_POST['txtName'])){
    $txtUsernameinput = $_POST['txtUsername'];
    $txtPasswordinput = $_POST['txtPassword'];
    $phonenuminput = $_POST['phonenum'];
    $txtConPasswordinput = $_POST['txtConPassword']
